...
axios.defaults.baseURL = "http://192.168.50.77:3000";
// axios.defaults.baseURL = "http://192.168.45.19:3000";
...
export default {
  methods: {
    ...
    $currencyFormat(value, format = "#,###") {
      ...
      var prefix = "";
      var d = "";
      // v = String(paseFloat(value).toFixed(maxFractionDigits));
