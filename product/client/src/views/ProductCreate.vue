        ...
        <div class="container">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-9">
              <div class="row">
                <div class="col-auto">
                  <select name="" id="" class="form-select" v-model="cate1" @change="changeCategory1">
                    <option :value="cate" :key="i" v-for="(cate, i) in category1">{{cate}}</option>
                  </select>
                </div>
                <div class="col-auto">
                  <select name="" id="" class="form-select" v-model="cate2" @change="changeCategory2">
                    <option :value="cate" :key="i" v-for="(cate, i) in category2">{{cate}}</option>
                  </select>
                </div>
                <div class="col-auto">
                  <select name="" id="" class="form-select" v-model="cate3" @change="changeCategory3">
...
export default {
  ...
  methods: {
    ...
    async getCategoryList(){
      ...
      console.log(category1[1]);

      let category2 = [];
      //filter : 조건에 만족하는 것만 가져와서 배열로 구성해줌
    ...
    productInsert(){
      if(this.product.product_name==""){
        return this.$swal("제품명은 필수 입력 값입니다.");
      }
