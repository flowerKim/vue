<template>
    ...
    <div class="container">
        <div class="float-end mb-1">
            <button type="button" class="btn btn-dark " @click="goToIndert()">제품등록</button>
        </div>
        <table class="table table-borderd">
            ...
            <tbody>
                <tr :key="i" v-for="(product, i ) in productList">
                    <td><img :src="product.path" style="height: 50px;width: auto;" alt=""></td>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-warning me-1" @click="goToUpdaet(product.id)">수정</button>
